...
class Resource {
    ...
    class SourceSignInSignUpScreen {
        class LauchScreen {
            ...
            public static var titleButtonSignUp  = "Login"
            public static var titleButtonCreate  = "Create an Account"
        }
        class LoginScreen {
            public static var lbl_TopTile = "Login"
            public static var lbl_titleTopDiscriptionLoginScreen = "Add your details to login"
           
         
            public static var txt_PlaceholderAccount =  "     " + "Name"
